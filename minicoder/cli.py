...
def _parse_args():
    ...
    p.add_argument("-m", "--model", help="Model name (default: $MINICODE_MODEL or gpt-4o)")
...
def main():
    ...
    if not config.api_key:
        ...
        console.print(
            "Set one of: MINICODE_API_KEY\n"
            "\nExamples:\n"
            "  # Minicode\n"
            "  export MINICODE_API_KEY=sk-...\n"
        )
        sys.exit(1)
...
def _repl(agent: Agent, config: Config):
    ...
    console.print(Panel(
        f"[bold]MiniCoder[/bold] v{__version__}\n"
    ...
    hist_path = os.path.expanduser("~/.minicoder_history")
